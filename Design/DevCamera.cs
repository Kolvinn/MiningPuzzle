...
{
    public partial class DevCamera : Camera2D
    {
        public static float zoomspeed = 0.1f, upperLimit = 0.001f, lowerLimit = 4f, currentzoom = 1, cameraSpeed = 2.1f;
        ...
        public void HandleBaseInput()
        {
            ...
            var down = Input.IsActionJustReleased("Zoom Out");
            var up = Input.IsActionJustReleased("Zoom In");
            if (down)
            {
                scrollDir = -1;
            }
